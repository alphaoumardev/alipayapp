...
import com.alpha.covid.beans.vo.DepartmentExportVo;
import com.alpha.covid.beans.vo.DepartmentVo;
import com.alpha.covid.mappers.DepartmentMapper;
import com.alpha.covid.models.Department;
import com.alpha.covid.structor.form.DepartmentForm;
...
{
    public List<Department> findAndCountDepart()
    {
        return this.baseMapper.findandcount();
    }
