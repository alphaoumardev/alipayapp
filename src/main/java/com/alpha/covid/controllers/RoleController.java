...
import com.alpha.covid.services.RoleMenuService;
import com.alpha.covid.services.RoleService;
...
public class RoleController
{
    ...
    {
        int res = roleService.updateRoleStatusById(id, forbidden ? SysConstant.FORBIDDEN : SysConstant.ACTIVE);
