<template>
  <div class="about">
    ...
    <div class="new-con">
      ...
      <p>皮克斯有一个现象，被我们的制片人叫作“看不见的完美硬币（the perfect
        ...
        CD全部倒塌散落在了地板上。麦克抱怨道：“哎，那些CD都是按字母顺序排列好的！”小女孩摇摇摆摆地走开了。这幕场景前后不到3秒钟，观众们只能够看到几个CD盒而已，但皮克斯的制作人员不仅为每一个CD盒制作了封面，还使用了可计算物体在运动时渲染效果变化的着色器。</p>
    </div>
    <br>
